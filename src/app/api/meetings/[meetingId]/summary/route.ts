      ...
      messages: [
        {
          ...
          content: isTeleapo
            ...
            [
              ...
              "文字起こしには誤認識が含まれます。意味が通らない語や固有名詞の揺れは、前後文脈から慎重に扱い、根拠が弱い内容を断定しないでください。",
              "分析では、営業側が言った希望的観測と、顧客側が実際に示した関心・懸念・条件を必ず分けてください。",
              "要約・評価・改善提案は、必ず文字起こし中の具体発話に基づけてください。一般論だけの評価は禁止です。",
