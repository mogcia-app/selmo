        ...
        messages: [
          {
            ...
            content: [
              ...
              "過去分析がある場合は、営業担当者の弱点を補うためのロープレにしてください。顧客は簡単に納得せず、未確認項目があると前向きにならない設定にしてください。",
              "difficulty は原則 hard にしてください。明らかに初回練習向けの場合のみ normal を許可します。easy は使わないでください。",
              "evaluationCriteria には、できたかどうか判定できる行動基準を6〜10個入れてください。特に課題深掘り、価値接続、予算確認、決裁/社内確認、導入時期確認、次回アクション確定を優先してください。",
